...
export default function RadarViewport() {
  useEffect(() => {
    ...
    // the browser has had a chance to draw the previous frame. The map and airport
    // layers keep their native SVG transforms so vectors stay sharp at every zoom.
