...
// MDST: the western corridor is also made parallel. The short eastern chord is
// shifted slightly west so it no longer runs directly through BEREL, while both
// circular sections still pass through the supplied 1.50 NM reference points.
const MDST_TWR_PATH =
  "M 70.65 95.15 L 71.50 93.00 A 3.12332709 3.12332709 0 0 0 65.49 91.48 L 60.34 88.99 L 60.05 90.17 L 65.20 92.66 A 3.18598785 3.18598785 0 0 0 70.65 95.15 Z";
