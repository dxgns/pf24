...
// MDST: the western corridor is a true parallelogram like MDPC. Its outer end is
// straight, both long edges are parallel, and the circular sections retain their
// existing shape/reference logic instead of extending the lower edge into the arc.
const MDST_TWR_PATH =
  "M 70.65 95.15 L 71.50 93.00 A 3.12332709 3.12332709 0 0 0 65.49 91.48 L 60.34 88.99 L 60.34 90.17 L 65.49 92.66 A 2.97939819 2.97939819 0 0 0 70.65 95.15 Z";
