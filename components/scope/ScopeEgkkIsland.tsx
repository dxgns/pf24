...
// Calibrated from the supplied PFTracker reference using the visible EGTT
// waypoint grid. The UK/Ireland coastline occupies approximately
// x=99.55..135.03 / y=1.48..44.34 in Scope map coordinates.
const EGKK_ISLAND_TRANSFORM = "matrix(0.19690 0 0 0.20384 99.55 1.48)";
const EGKK_ISLAND_WIDTH = 180.16568;
const EGKK_ISLAND_HEIGHT = 210.29182;
...
export default function ScopeEgkkIsland() {
  ...
  return createPortal(
    <div
      ...
      data-pf24-egkk-island-layer="true"
    ...
    >
      ...
      >
        <g data-map-layer="egkk-island-coastline">
          <image
            href="/scope/egkk-island.svg"
            x={0}
            y={0}
            width={EGKK_ISLAND_WIDTH}
            height={EGKK_ISLAND_HEIGHT}
            transform={EGKK_ISLAND_TRANSFORM}
